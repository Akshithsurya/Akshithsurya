...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=500&size=22&duration=3000&pause=1000&color=00C7B7&center=true&vCenter=true&width=700&height=50&lines=NASA+Space+Apps+2025+%E2%80%94+Global+Nominee;ISRO+Space+Week+%E2%80%94+1st+Prize%2C+Project;ISRO+Space+Week+%E2%80%94+2nd+Prize%2C+Quiz;Building+EXOVision%2C+ESP_Penetrator%2C+Vulcan%2C+Arivu;Kerala+School+of+Mathematics%2C+six+centuries+later)](https://git.io/typing-svg)
...
<img src="https://skillicons.dev/icons?i=cpp,csharp,python,go,lua,bash,js,ts,react,vue,threejs,tailwind,tensorflow,arduino,raspberrypi,linux,docker,git,netlify,figma&perline=10" alt="Tech Stack" />
